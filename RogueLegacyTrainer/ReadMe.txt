========================================================================
    APLICACIÓN DE CONSOLA: RogueLegacyTrainer Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación RogueLegacyTrainer.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación RogueLegacyTrainer.


RogueLegacyTrainer.vcxproj
...
RogueLegacyTrainer.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado RogueLegacyTrainer.pch y un archivo de tipos precompilados llamado StdAfx.obj.
